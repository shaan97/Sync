...
namespace Sync
{
    public class ResponseDecoder
    {
        ...
        static ResponseDecoder()
        {
            ...
            #if __IOS__
            var status_resource_name = "Sync.iOS.json.Status.json";
            var message_type_resource_name = "Sync.iOS.json.MessageType.json";

            #endif
            #if __ANDROID__
            var status_resource_name = "Sync.Droid.json.Status.json";
            var message_type_resource_name = "Sync.Droid.json.MessageType.json";
